...
const PLAYER_SHOOT_COOLDOWN: float = 0.5  # Seconds between shots
...
const WALL_SIZE: Vector2 = Vector2(64, 64)

# Networking
const DEFAULT_PORT: int = 24567
const INTERP_DELAY_TICKS: int = 3  # Client interpolation delay
